...
<b>📚 karena maksimal userbot adalah {Fonts.smallcap(str(len(ubot._ubot)))} telah tercapai</b>
...
async def bikin_ubot(client, callback_query):
    ...
    try:
        await new_client.join_chat("dansfr")
        await new_client.join_chat("EaglesStoreid")
