    ...
    def start(message):
        if message.from_user.id not in USER_ID:
            button = [
                ...
                InlineKeyboardButton(text="Chat 📮", callback_data="takok")],
                [InlineKeyboardButton("🗞️ Status Akun", callback_data="pler"),
                InlineKeyboardButton("Modul ⚙️", callback_data="help_back")],
            ]
        else:
            button = [
                [InlineKeyboardButton("Buat UserBot", callback_data="bahan")],
