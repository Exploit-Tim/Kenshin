...
@ubot.on_message(filters.command("curhat", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("knl", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("umm", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("malu", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("be", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("psn", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("kasihan", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("rosting", PREFIX) & filters.me)
...
@ubot.on_message(filters.command("peka", PREFIX) & filters.me)
